                    ...
                    <div class="card-body">      
                        ...
                        <div class="tab-pane" id="settings">
                            ...
                            <form method="post" action="{{ route('doctor.store') }}" enctype="multipart/form-data">
                                ...
                                <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Doctor</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="time"type="text" name="time" class="form-control @error('time') is-invalid @enderror"   >
                                            @error('time')
                                        <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
